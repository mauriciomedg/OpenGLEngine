...
Mesh Mesh::createCube()
{
    const float vertices[] = {
        -0.5f, -0.5f, -0.5f, 0.90f, 0.18f, 0.22f,
         0.5f, -0.5f, -0.5f, 0.95f, 0.62f, 0.18f,
         0.5f,  0.5f, -0.5f, 0.20f, 0.72f, 0.36f,
        -0.5f,  0.5f, -0.5f, 0.12f, 0.56f, 0.92f,
        -0.5f, -0.5f,  0.5f, 0.72f, 0.24f, 0.88f,
         0.5f, -0.5f,  0.5f, 0.10f, 0.78f, 0.82f,
         0.5f,  0.5f,  0.5f, 0.86f, 0.82f, 0.20f,
        -0.5f,  0.5f,  0.5f, 0.84f, 0.32f, 0.52f,
    };
    ...
    return Mesh(vertices, 48, indices, 36);
}
